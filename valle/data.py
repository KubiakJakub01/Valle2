...
from .utils import load_tsv, log_error, log_info, tokenize_phonemes
...
class ValleDataset(Dataset):
    ...
    def __init__(self, metadata_list: list[dict], config: ConfigValle):
        ...
        log_info(f'Vocabulary size: {self.config.vocab_size}')
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            tokens = tokenize_phonemes(phonemes, self.config.phoneme_to_id)
